...
async function tournament(): Promise<void> {
  ...
  const config: TournamentConfig = {
    ...
    // 20 stages: aggressive early culling, gentle late refinement.
    // ~6000 → ~50 survivors. Early rounds are cheap (few coins, big kills).
    stages: [
      { weeks: 1, symbols: 1, killRate: 0.30 },
      { weeks: 1, symbols: 1, killRate: 0.30 },
      { weeks: 1, symbols: 1, killRate: 0.25 },
      { weeks: 1, symbols: 2, killRate: 0.25 },
      { weeks: 1, symbols: 2, killRate: 0.20 },
      { weeks: 1, symbols: 2, killRate: 0.20 },
      { weeks: 1, symbols: 3, killRate: 0.20 },
      { weeks: 1, symbols: 3, killRate: 0.15 },
      { weeks: 1, symbols: 3, killRate: 0.15 },
      { weeks: 1, symbols: 4, killRate: 0.15 },
      { weeks: 1, symbols: 4, killRate: 0.10 },
      { weeks: 1, symbols: 4, killRate: 0.10 },
