      ...
      '@nx/enforce-module-boundaries': [
        'error',
        {
          ...
          depConstraints: [
            ...
            { sourceTag: 'scope:data-feed', onlyDependOnLibsWithTags: ['scope:types',  'scope:test-utils', 'scope:exchange-client'] },
            { sourceTag: 'scope:position-manager', onlyDependOnLibsWithTags: ['scope:types',  'scope:test-utils', 'scope:order-executor', 'scope:risk-manager'] },
            ...
            { sourceTag: 'scope:order-executor', onlyDependOnLibsWithTags: ['scope:types',  'scope:test-utils', 'scope:exchange-client'] },
            { sourceTag: 'scope:scanner', onlyDependOnLibsWithTags: ['scope:types',  'scope:test-utils', 'scope:indicators'] },
            { sourceTag: 'scope:strategy', onlyDependOnLibsWithTags: ['scope:types',  'scope:test-utils', 'scope:exchange-client', 'scope:order-executor', 'scope:scanner', 'scope:position-manager', 'scope:risk-manager', 'scope:margin-guard'] },
