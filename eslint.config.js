      ...
      '@nx/enforce-module-boundaries': [
        'error',
        {
          ...
          depConstraints: [
            ...
            { sourceTag: 'scope:backtest-engine', onlyDependOnLibsWithTags: ['scope:types',  'scope:test-utils', 'scope:event-bus', 'scope:exchange-client', 'scope:data-feed', 'scope:order-executor', 'scope:strategy', 'scope:reporting', 'scope:indicators', 'scope:scanner', 'scope:position-manager', 'scope:risk-manager'] },
            ...
            { sourceTag: 'scope:live-runner', onlyDependOnLibsWithTags: ['scope:types',  'scope:test-utils', 'scope:event-bus', 'scope:exchange-client', 'scope:data-feed', 'scope:order-executor', 'scope:strategy', 'scope:storage'] },
            { sourceTag: 'scope:arena', onlyDependOnLibsWithTags: ['scope:types',  'scope:test-utils', 'scope:event-bus', 'scope:exchange-client', 'scope:data-feed', 'scope:order-executor', 'scope:strategy', 'scope:reporting', 'scope:backtest-engine', 'scope:indicators', 'scope:scanner', 'scope:position-manager', 'scope:risk-manager'] },
            { sourceTag: 'scope:evolver', onlyDependOnLibsWithTags: ['scope:types',  'scope:test-utils', 'scope:arena'] },
            { sourceTag: 'scope:parity-checker', onlyDependOnLibsWithTags: ['scope:types',  'scope:test-utils', 'scope:backtest-engine', 'scope:reporting', 'scope:storage', 'scope:strategy'] },
            { sourceTag: 'scope:reporting', onlyDependOnLibsWithTags: ['scope:types',  'scope:test-utils'] },
            { sourceTag: 'scope:test-utils', onlyDependOnLibsWithTags: ['scope:types', 'scope:event-bus'] },
          ],
        },
      ],
    },
