      ...
      '@nx/enforce-module-boundaries': [
        'error',
        {
          ...
          depConstraints: [
            ...
            { sourceTag: 'scope:margin-guard', onlyDependOnLibsWithTags: ['scope:types', 'scope:event-bus'] },
            ...
            { sourceTag: 'scope:strategy', onlyDependOnLibsWithTags: ['scope:types', 'scope:event-bus', 'scope:exchange-client', 'scope:order-executor', 'scope:scanner', 'scope:position-manager', 'scope:risk-manager', 'scope:margin-guard'] },
