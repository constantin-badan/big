      ...
      '@nx/enforce-module-boundaries': [
        'error',
        {
          ...
          depConstraints: [
            ...
            { sourceTag: 'scope:live-runner', onlyDependOnLibsWithTags: ['scope:types', 'scope:event-bus', 'scope:exchange-client', 'scope:data-feed', 'scope:order-executor', 'scope:strategy'] },
